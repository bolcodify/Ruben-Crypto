  ...
  return (
    <div className="space-y-12 pb-20">
      <div>
        ...
        <p className="text-[#a1a1aa] mt-2">The latest news and analysis from the world of digital assets.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          {newsArticles.map((article) => (
            <motion.article 
              ...
              className="bg-[#111111] border border-white/10 rounded-[32px] overflow-hidden group cursor-pointer"
            >
              ...
              <div className="p-8 space-y-4">
                ...
                <h2 className="text-2xl font-bold group-hover:text-blue-500 transition-colors">{article.headline}</h2>
                <p className="text-[#a1a1aa] leading-relaxed">{article.excerpt}</p>
        ...
        <aside className="space-y-8">
          <div className="bg-[#111111] border border-white/10 rounded-[32px] p-8 space-y-6">
            <h3 className="text-xl font-bold">Trending Topics</h3>
            <div className="flex flex-wrap gap-2">
              {['Bitcoin', 'Ethereum', 'DeFi', 'NFTs', 'L2', 'Regulation', 'Mining', 'Web3'].map((tag) => (
                <button key={tag} className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-sm hover:bg-white/10 transition-colors">
                  #{tag}
                </button>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[32px] p-8 space-y-6">
            <h3 className="text-xl font-bold">Subscribe to Insights</h3>
            <p className="text-blue-100 text-sm">Get the latest market analysis delivered directly to your inbox every morning.</p>
